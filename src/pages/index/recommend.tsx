...
export const RecommendContent: FC = () => {
  ...
  return (
    <Section title="Gợi ý cho bạn" padding="title-only">
      <Swiper slidesPerView={2} spaceBetween={16} className="px-4">
            ...
            <ProductPicker product={product}>
              {({ open }) => (
                <div onClick={open} className="space-y-3">
                  <Box
                    className="relative w-[160px] h-[160px] aspect-square rounded-lg bg-cover bg-center bg-skeleton"
                  ...
                  <Box className="space-y-1">
                    ...
                    <Text size="large" className="text-gray font-bold text-primary">
